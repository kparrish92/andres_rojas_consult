...
The Picture Naming Task shows the same results as the first two tasks: all participants occluded more at the post-test. There was only a main effect of *time* and all the participants showed evidence of an increase in occlusions at post-test (positive parameter estimates based on random effects).
